...
import { useDeletePortfolioMutation } from "@/redux/portfolio/portfolioApi";

const PortfolioEditDelete = ({ id }: { id: string }) => {
...
export default PortfolioEditDelete;
